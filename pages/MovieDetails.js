...
const MovieDetails = () => {
    ...
    return (
        ...
        <div className="bg-gray-800 relative" >
            ...
            <div className="flex flex-row items-center h-screen  z-20">

                <div className="shadow-2xl z-20 flex relative bg-center bg-cover flex-col justify-center h-3/4 w-1/2 items-start ml-20 rounded" style={{ backgroundImage: "url('"+router.query.movieCover+"')" }}>
            ...
            <div className="flex flex-col items-start justify-start mt-20 h-3/4 w-full z-20">
            ...
            <button className="bg-red-700 ml-5 px-5 py-1 rounded text-slate-50 opacity-100 hover:opacity-100">Add to My List</button>
              ...
              <p className="text-slate-50 mt-5  pl-5  pr-5 w-3/4 z-20 ">{router.query.movieDescription}</p>
            </div>
