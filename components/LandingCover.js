...
const LandingCover = () => {
    return ( <div className="bg-[url('../assets/cover.jpg')] bg-cover hover:bg-bottom bg-center duration-1000 z-20" style={{height:"50rem", zIndex:"20"}}>
        ...
        <img src="https://pngpress.com/wp-content/uploads/2020/09/uploads_netflix_netflix_PNG11.png" className="w-32 ml-1 p-0 z-20" />
        <h1 className="text-slate-50 text-6xl font-bold z-20">INTERSTELLAR</h1>
